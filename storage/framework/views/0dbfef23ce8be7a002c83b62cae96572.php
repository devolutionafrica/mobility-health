<?php $__env->startSection('title', 'Nouvelle tarification'); ?>
...
<?php $__env->startSection('content'); ?>
    <form class="px-lg-4" enctype="multipart/form-data" action="<?php echo e(route('package.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="insurance_policy_id" value="<?php echo e($insurancePolicyId); ?>">
        <div class="row align-items-center">
            <div class="col-auto">
                <a href="<?php echo e(route('insurance_policies.show',["insurancePolicy"=>$insurancePolicyId])); ?>" class="btn btn-icon btn-label-primary">
                        ...
                        <div class="row mb-4">
                            <div class="col-xl-4">
                                ...
                                <select id="geographic_area_id"
                                    ...
                                    <?php $__currentLoopData = \App\Models\GeographicArea::query()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            <?php if(old("geographic_area_id",'') == $item): echo 'selected'; endif; ?>
                                            value="<?php echo e($item->id); ?>"><?php echo e(__($item->name)); ?></option>
                        ...
                        <div class="row mb-6">
                            <div class="col">
                                ...
                                <select id="validity_period_type"
                                        ...
                                        class="select2 form-select">
                                    <?php $__currentLoopData = ["day","month","year"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            <?php if(old("validity_period_type",'month') == $item): echo 'selected'; endif; ?>
                                            value="<?php echo e($item); ?>"><?php echo e(__($item)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-xl-4">
                                ...
                                <select id="validity_period_value"
                                    ...
                                    <?php for($i=1;$i<31;$i++): ?>
                                        <option
                                            <?php if(old("validity_period_value",'') == $i): echo 'selected'; endif; ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u438288564/domains/ibemscreative.in/public_html/mobility/resources/views/pages/insurance-policies/package/create.blade.php ENDPATH**/ ?>