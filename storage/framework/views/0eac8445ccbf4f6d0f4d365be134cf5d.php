...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <?php if(!isset($navbarFull)): ?>
        <div class="app-brand demo">
            ...
            <a href="<?php echo e(url('/')); ?>" class="layout-menu-toggle menu-link text-large ms-auto">
...
<?php /**PATH /home/u438288564/domains/ibemscreative.in/public_html/mobility/resources/views/layouts/sections/menu/verticalMenu.blade.php ENDPATH**/ ?>