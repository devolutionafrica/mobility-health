...
<?php $__env->startSection('content'); ?>
    <form method="post" id="delete-form" action="<?php echo e(route("user.delete",["user"=>$user->id])); ?>">
        <?php echo csrf_field(); ?>
        <?php echo method_field("DELETE"); ?>
    </form>
    <form class="px-lg-4" enctype="multipart/form-data"
          action="<?php echo e(route("user.update",["user"=>$user->id,"type"=>$type])); ?>"
          method="post">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        ...
                        <p class="mb-0">
                            ...
                            <?php if($type == \App\Models\Enums\UserType::HealthPartner): ?>
                                partenaire de santé
                            <?php elseif($type == \App\Models\Enums\UserType::ReferentDoctor): ?>
                                médecin référent
                            <?php else: ?>
                                administrateur
                            <?php endif; ?>
                            ...
                            <div class="col-7 col-xl-4">
                                <div class="border border-2 rounded p-2">
                                    <div class="h-px-150 w-100 pb-2 d-flex justify-content-center">
                                        <img
                                            src="<?php echo e($user->avatar !=null  ? urlGen(src: route("image.indexUrl",["path"=>$user->avatar->path]),fit: "contain") :"/logo/user-circle.png"); ?>"
                                ...
                                <div class="col-6 col-lg-4">
                                    <div class="form-check custom-option custom-option-basic">
                                        <label class="form-check-label custom-option-content pb-2" for="male">
                                            <input
                                                <?php if($user->gender == "male"): echo 'checked'; endif; ?>
                                                name="gender"
                                ...
                                <div class="col-6 col-lg-4">
                                    <div class="form-check custom-option custom-option-basic">
                                        <label class="form-check-label custom-option-content pb-2" for="female">
                                            <input
                                                <?php if($user->gender == "female"): echo 'checked'; endif; ?>
                                    ...
                                    <div class="col-12 col-md-7">
                                        ...
                                        <select id="country" name="country_id" class="select2-icons form-select">
                                            <?php $__currentLoopData = \App\Models\Country::query()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    <?php if(old("country_id",$user->country_id) ==$item->id): echo 'selected'; endif; ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                <select id="vendor" name="role" class="select2 form-select">
                                    <option
                                        value="admin" <?php if(old("role",$user->role) ==\App\Models\Enums\UserType::Admin ): echo 'selected'; endif; ?>>
                                        Administrateur
                                    </option>
                                    <option
                                        value="manager" <?php if(old("role",$user->role) ==\App\Models\Enums\UserType::Manager ): echo 'selected'; endif; ?>>
                                        Gestionnaire
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="mb-6">
                                <select id="referent_doctor_specialty" name="speciality_id" class="select2 form-select">
                                    <?php $__currentLoopData = \App\Models\Speciality::query()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            <?php if(old("speciality_id",$user->speciality_id) == $item->id): echo 'selected'; endif; ?> value="<?php echo e($item->id); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-6 gap-2">
                            <div class="col-12">
                                <a href="<?php echo e(route("password.edit",["user"=>$user->id])); ?>" type="submit"
                        ...
                        <div class="row">
                            <div class="col">
                                <input
                                    ...
                                    name="location[lat]"
                                    value="<?php echo e(old('location.lat',$user->location["lat"] ?? "")); ?>"
                            ...
                            <div class="col">
                                <input
                                    ...
                                    name="location[lon]"
                                    value="<?php echo e(old('location.lon',$user->location["lon"] ?? "")); ?>"
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u438288564/domains/ibemscreative.in/public_html/mobility/resources/views/pages/users/edit.blade.php ENDPATH**/ ?>