...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      serverSide: true,
      ajax: {
        url: baseUrl + location.pathname.substring(1),
      },
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
              ...
              return  full["linkHTML"] ?? '';
            return (
              '<div class="d-flex align-items-center gap-50">' +
              `<a class="btn btn-sm btn-icon edit-record btn-text-secondary rounded-pill waves-effect" href="${full["links"]["edit"]}"><i class="ti ti-edit"></i></a>` +
      ...
      buttons: location.pathname.startsWith('/customer') ? []: [
        {
          extend: 'collection',
  ...
  $(document).on('click', '.delete-record', function (e) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        Swal.fire({
          title: 'Annulé',
          text: 'L\'utilisateur n\'est pas supprimé !',
          icon: 'error',
          customClass: {
            confirmButton: 'btn btn-success'
          }
  ...
  $('.add-new').on('click', function () {
    ...
    $('#offcanvasAddUserLabel').html('Nouveau');
  });
