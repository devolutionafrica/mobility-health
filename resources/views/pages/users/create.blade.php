...
@section('content')
    <form class="px-lg-4" enctype="multipart/form-data" action="{{ route("user.store",["type"=>$type]) }}" method="post">
        @csrf
        <!-- Add Product -->
        @php
            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    <div class="d-flex flex-column justify-content-center">
                        ...
                        <p class="mb-0">
                            Enrégistrer d'un profil {{ $suffix }}
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="mb-6">
                                <select id="referent_doctor_specialty" name="speciality_id" class="select2 form-select">
                                    @foreach(\App\Models\Speciality::query()->get() as $item)
                                        <option @selected(old("specialty_id") == $item->id) value="{{$item->id}}">
                                            {{$item->name}}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-6 gap-2">
                            <div class="col-12">
                                ...
                                <input required type="password"
                                       @class(["form-control","is-invalid"=>$errors->has('password')]) id="password"
                                       placeholder=""
                            ...
                            <div class="col-12">
                                ...
                                <input required type="password"
                                       @class(["form-control","is-invalid"=>$errors->has('password_confirmation')]) id="password_confirmed"
