...
@section('content')
    <form class="px-lg-4"
          action="{{ route("questionGroup.update",["questionGroup"=>$questionGroup->id]) }}"
          method="post">
        @csrf
        @method("PUT")
        @php $id=\Illuminate\Support\Facades\Request::query("id") @endphp
        <div class="row align-items-center">
            <div class="col-auto">
                <a href="{{ $id == null ? route("question.create") : route("question.edit",['question'=>$id]) }}" class="btn btn-icon btn-label-primary">
                            ...
                            <div class="col-lg-12">
                                ...
                                <select id="page-index"
                                    ...
                                    @foreach([\App\Models\Enums\QuestionType::Complementary,\App\Models\Enums\QuestionType::Register] as $item)
                                        <option
                                            @selected($item->value == $questionGroup->question_type)
                        ...
                        <div class="row mb-4 gap-2">
                            <div class="col-12">
                                ...
                                <input
                                    ...
                                    placeholder=""
                                    name="title"
                                    value="{{old('title',$questionGroup->title)}}"
