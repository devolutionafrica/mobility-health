...
<?php $__env->startSection('title', 'Nouveau groupe'); ?>
...
<?php $__env->startSection('content'); ?>
    <form class="px-lg-4" action="<?php echo e(route("questionGroup.store")); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="row align-items-center">
            <div class="col-auto">
                <a href="<?php echo e(route("question.create")); ?>" class="btn btn-icon btn-label-primary">
                            ...
                            <div class="col-lg-12">
                                ...
                                <select id="page-index"
                                    ...
                                    <?php $__currentLoopData = [\App\Models\Enums\QuestionType::Complementary,\App\Models\Enums\QuestionType::Register]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            <?php if($loop->index == 2): echo 'selected'; endif; ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-lg-2">
                                ...
                                <select id="page-index"
                                    ...
                                    <?php for($i=1;$i<=4;$i++): ?>
                                        <option
                                            <?php if($i == 1): echo 'selected'; endif; ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u438288564/domains/ibemscreative.in/public_html/mobility/resources/views/pages/questions/group/create.blade.php ENDPATH**/ ?>