...
// Variables
return [
  "creatorName" => "Mobility Health",
  "creatorUrl" => "https://pixinvent.com",
  "templateName" => "Mobility Health",
  "templateSuffix" => "Mobility Health",
  "templateVersion" => "1.0.0",
  "templateFree" => false,
  "templateDescription" => "Mobility Health",
  "templateKeyword" => "Mobility Health",
