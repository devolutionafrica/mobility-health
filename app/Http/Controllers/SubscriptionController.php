...
class SubscriptionController extends Controller
{
    ...
    public function edit(Request $request, Subscription $subscription, string $action)
    {
    ...
    public function update(Request $request, Subscription $subscription, string $action)
    {
        ...
        if ($action == "validate") {
            ...
            $subscription->update([
                ...
                "date_end" => match ($subscription->period["type"]) {
                    "year" => $dateStart->addYears(intval($subscription->period["value"])),
                    "day" => $dateStart->addDays(intval($subscription->period["value"])),
                    default => $dateStart->addMonths(intval($subscription->period["value"]))
                },
            ]);
