<?php $__env->startSection('title', 'Nouvelle zone géographique'); ?>
...
<?php $__env->startSection('content'); ?>
    <form class="px-lg-4" enctype="multipart/form-data" action="<?php echo e(route('geographic_area.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="select2-primary">
                                        <select multiple id="countries" name="countries[]" class="select2 form-select">
                                            <?php $__currentLoopData = \App\Models\Country::query()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    <?php if(in_array($item->id,old("countries",[]))): echo 'selected'; endif; ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u438288564/domains/ibemscreative.in/public_html/mobility/resources/views/pages/geographic-area/create.blade.php ENDPATH**/ ?>